...
const SUMUP_API_KEY = process.env.SUMUP_API_KEY || 'sup_sk_XDolLm0ujtxSZLsw3Br0bANAMm2gijcS1';
      ...
      <body>
        <div class="container">
          ...
          <form method="POST" action="/checkout">
            ...
            <input type="hidden" name="cart_items" value='{"items":[{"title":"Test Product","quantity":1,"price":200,"line_price":200}]}'>
